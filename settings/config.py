...
class Settings(BaseSettings):
    ...
    smtp_username: str = Field(default='5998d455aadf0a', description="Username for SMTP server")
    smtp_password: str = Field(default='7994ae504cd004', description="Password for SMTP server")
